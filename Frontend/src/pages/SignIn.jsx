...
//               className="w-full mt-1 px-4 py-2 rounded-lg bg-[#0b0b0f] border border-white/10 text-white placeholder-gray-500 outline-none focus:border-violet-500"
//             />
//           </div>
...
//               required
//               className="w-full mt-1 px-4 py-2 rounded-lg bg-[#0b0b0f] border border-white/10 text-white focus:border-violet-500 outline-none"
//             />
//           </div>
...
//             className="w-full bg-violet-600 hover:bg-violet-700 disabled:opacity-60 text-white py-2 rounded-lg font-medium"
//           >
